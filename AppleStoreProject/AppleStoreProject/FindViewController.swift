...
final class FindViewController: UIViewController {
    ...
    @objc private func productViewTapped(sender: UITapGestureRecognizer) {
        ...
        case beltView:
            ...
            detailProductVC.productText = beltLable.text ?? ""
            detailProductVC.productPrice = "3 900.00 руб."
            detailProductVC.imagesNamesArray = beltImagesArray
        case caseBownView:
            detailProductVC.image = "caseBown"
            detailProductVC.productText = caseBownLable.text ?? ""
            detailProductVC.productPrice = "20 990.00 руб."
            detailProductVC.imagesNamesArray = caseBownImagesArray
        default:
            break
        }
